class MultiTouchControls {
  ...
  void display() {
    ...
    pushMatrix();
    {
      ...
      ellipse(cos(p[1].acc.heading()) * p[1].acc.mag()*100*(controlersSizeSmallBall/game.emScale), sin(p[1].acc.heading())*p[1].acc.mag()*100*(controlersSizeSmallBall/game.emScale), controlersSizeSmallBall, controlersSizeSmallBall);  
    ...
    pushMatrix();
    {
      ...
      ellipse(cos(p[0].acc.heading()) * p[0].acc.mag()*100*(controlersSizeSmallBall/game.emScale), sin(p[0].acc.heading()) * p[0].acc.mag()*100*(controlersSizeSmallBall/game.emScale), controlersSizeSmallBall, controlersSizeSmallBall);
